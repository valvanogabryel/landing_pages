  ...
  return (
    <TextWrapper>
      ...
      <ParagraphWrapper>
        ...
        <p>
          Bitcoin foi o primeiro, e desde então cresceu para milhares de tokens
          lançados todos com o objetivo de corrigir um problema ou outro com
          alguns simplesmente FOMOing o momento. Nosso objetivo é para trazer
          adoção em massa para o espaço de criptomoeda, simplificando-o. Quão
          longe? Então para baixo que até mesmo uma celebridade pode explicar
          isso em palavras simples para seus seguidores e tê-los baixar um
          aplicativo, comprar na moeda social de sua pessoa favorita e assistir
          seus investimento como é com outro projeto de criptomoeda.
        </p>
        <p>
      ...
      <ParagraphWrapper>
        <p>
          ...
          as plataformas convencionais de mídia social podem oferecer.
        </p>
        <p>
